...
<body>
	<h3>회원 가입</h3>
	<form action="form4_process.jsp" name="member" method ="post">
		...
		<p>연락처 : <select name="phone1">
		 ...
		 <p> 취미 : 독서<input type="checkbox" name="hobby1" checked>
		 		    영화<input type="checkbox" name="hobby2">
		 		   운동<input type="checkbox" name="hobby3">
		 <p> <textarea name="comment" cols="30" row="10" placeholder="가입 인사를 입력해주세요"></textarea>
